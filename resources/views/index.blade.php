...
<div class="min-h-screen bg-gradient-to-br from-green-800 via-green-600 to-green-900">
    ...
    <section id="home" class="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div class="absolute inset-0 overflow-hidden">
            <div class="parallax-element absolute top-20 left-10 w-32 h-32 bg-green-400 rounded-full opacity-20 blur-3xl"></div>
            <div class="parallax-element absolute top-40 right-20 w-24 h-24 bg-yellow-400 rounded-full opacity-20 blur-2xl"></div>
            <div class="parallax-element absolute bottom-20 left-20 w-40 h-40 bg-orange-400 rounded-full opacity-20 blur-3xl"></div>
        </div>
        ...
        <div class="relative z-10 container mx-auto px-4 py-20">
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="lg:w-1/2 text-center lg:text-left">
                    <div class="mb-8">
                        <span class="inline-block bg-yellow-400 text-green-900 px-6 py-2 rounded-full text-lg font-bold mb-4 shadow-lg magnetic gsap-fade-up">
                            THE EXCITING
                        </span>
                    ...
                    <div class="gsap-fade-up">
                        <button class="group bg-yellow-400 hover:bg-yellow-300 text-green-900 font-bold py-4 px-8 rounded-full text-xl shadow-2xl magnetic" id="hero-cta">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="space-y-6">
                            <div class="relative group cursor-pointer gsap-scale">
                                <div class="bg-gradient-to-br from-orange-400 to-yellow-600 rounded-3xl p-1 shadow-2xl magnetic">
                                    <div class="bg-orange-100 rounded-2xl p-4 h-64 flex items-center justify-center overflow-hidden">
                                        <i data-lucide="sunrise" class="w-24 h-24 text-orange-600"></i>
                                    </div>
                                </div>
                                <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-6">
                                    <span class="text-white font-semibold">Sunrise Adventure</span>
                                </div>
                            </div>

                            <div class="relative group cursor-pointer gsap-scale">
                                <div class="bg-gradient-to-br from-green-400 to-emerald-600 rounded-3xl p-1 shadow-2xl magnetic">
                                    <div class="bg-green-100 rounded-2xl p-4 h-48 flex items-center justify-center overflow-hidden">
                        ...
                        <div class="pt-12">
                            <div class="relative group cursor-pointer gsap-scale">
                                <div class="bg-gradient-to-br from-amber-400 to-orange-600 rounded-3xl p-1 shadow-2xl magnetic">
                                    <div class="bg-amber-100 rounded-2xl p-4 h-80 flex items-center justify-center overflow-hidden">
                                        <div class="text-center">
                                            <i data-lucide="mountain" class="w-32 h-32 text-amber-600 mx-auto mb-4"></i>
                                            <div class="bg-amber-600 rounded-full w-16 h-16 mx-auto flex items-center justify-center">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2">
                    ...
                    <div class="space-y-6 text-lg text-green-700 leading-relaxed">
                        ...
                        <p class="gsap-fade-up">
                            Suaka margasatwa ini, yang dikenal sebagai <span class="font-bold text-green-800">Fajar World</span>, bukan sekedar kebun binatang, melainkan sebuah konsep visioner yang memadukan konservasi, edukasi, dan hiburan.
                        </p>

                        <p class="gsap-fade-up">
                            Kisah Fajar World berawal dari kecintaan mendalam terhadap satwa dan komitmen terhadap kesejahteraan mereka. Semangat inilah yang mendorong para pendirinya untuk menciptakan tempat-tempat di mana satwa dapat hidup bebas dan diperlakukan dengan layak.
                        </p>
                    </div>

                    <div class="mt-8 gsap-fade-up">
                        <button class="group bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-8 rounded-full shadow-xl magnetic">
                            <span class="flex items-center gap-3">
    ...
    <!-- Gallery Section -->
    <section id="gallery" class="py-20 bg-gradient-to-br from-green-900 via-green-800 to-green-700 relative overflow-hidden">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-5xl font-black text-white mb-4 gsap-fade-up">
                    <span class="text-reveal">GALLERY</span>
                </h2>
                <p class="text-green-200 text-xl gsap-fade-up">Jelajahi keindahan Fajar World melalui foto-foto menakjubkan</p>
            ...
            <div class="text-center mt-12">
                <button class="bg-yellow-400 hover:bg-yellow-300 text-green-900 font-bold py-4 px-8 rounded-full shadow-xl magnetic gsap-fade-up">
                    <span class="flex items-center gap-3">
    ...
    <section id="tickets" class="py-20 bg-gradient-to-br from-green-800 via-green-700 to-green-900 relative overflow-hidden">
        <div class="absolute inset-0 bg-black opacity-20"></div>

        <!-- Background Pattern -->
        <div class="absolute inset-0 opacity-10">
            <div class="absolute top-20 left-20 w-64 h-64 border-4 border-white rounded-full floating-element"></div>
            <div class="absolute bottom-20 right-20 w-48 h-48 border-4 border-yellow-400 rounded-full floating-element"></div>
        </div>
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div class="ticket-card group relative gsap-fade-left">
                    <div class="absolute inset-0 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-3xl blur-xl opacity-75 group-hover:opacity-100 transition-opacity"></div>
                    <div class="relative bg-white rounded-3xl p-8 shadow-2xl magnetic">
                        <div class="text-center mb-8">
                            <div class="bg-gradient-to-r from-green-600 to-green-800 text-white rounded-2xl py-3 px-6 mb-6">
                ...
                <div class="ticket-card group relative gsap-fade-right">
                    ...
                    <div class="relative bg-white rounded-3xl p-8 shadow-2xl border-4 border-gradient-to-r from-purple-400 to-pink-400 magnetic">
                        ...
                        <div class="text-center mb-8 mt-4">
                            <div class="bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-2xl py-3 px-6 mb-6">
    ...
    <section id="contact" class="py-20 bg-gradient-to-r from-yellow-100 to-orange-100">
        <div class="container mx-auto px-4">
                    ...
                    <div class="bg-white rounded-3xl p-8 shadow-xl gsap-fade-left magnetic">
                        ...
                        <div class="text-center">
                            ...
                            <div class="flex justify-center gap-4">
                                <a href="#" class="bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-xl magnetic">
                                    <i data-lucide="facebook" class="w-6 h-6"></i>
                                </a>
                                <a href="#" class="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white p-3 rounded-xl magnetic">
                                    <i data-lucide="instagram" class="w-6 h-6"></i>
                                </a>
                                <a href="#" class="bg-red-600 hover:bg-red-700 text-white p-3 rounded-xl magnetic">
                                    <i data-lucide="youtube" class="w-6 h-6"></i>
                                </a>
                                <a href="#" class="bg-green-600 hover:bg-green-700 text-white p-3 rounded-xl magnetic">
            ...
            <div class="mt-16 text-center">
                <h3 class="text-2xl font-black text-green-800 mb-8 gsap-fade-up">MEMBER OF</h3>
                <div class="flex flex-wrap justify-center items-center gap-8 opacity-60 hover:opacity-100 transition-opacity">
                    <div class="w-16 h-16 bg-gradient-to-r from-blue-500 to-green-500 rounded-full flex items-center justify-center magnetic gsap-scale">
                        <i data-lucide="shield" class="w-8 h-8 text-white"></i>
                    </div>
                    <div class="w-16 h-16 bg-gradient-to-r from-red-500 to-yellow-500 rounded-full flex items-center justify-center magnetic gsap-scale">
                        <i data-lucide="globe" class="w-8 h-8 text-white"></i>
                    </div>
                    <div class="w-16 h-16 bg-gradient-to-r from-blue-600 to-blue-800 rounded-full flex items-center justify-center magnetic gsap-scale">
                        <i data-lucide="users" class="w-8 h-8 text-white"></i>
                    </div>
                    <div class="w-16 h-16 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full flex items-center justify-center magnetic gsap-scale">
                        <i data-lucide="camera" class="w-8 h-8 text-white"></i>
                    </div>
                    <div class="w-16 h-16 bg-gradient-to-r from-green-600 to-blue-600 rounded-full flex items-center justify-center magnetic gsap-scale">
