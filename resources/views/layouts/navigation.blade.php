    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-4">
            ...
            <div class="hidden lg:block gsap-fade-right">
                <button class="bg-yellow-400 hover:bg-yellow-300 text-green-900 font-bold py-3 px-6 rounded-full transform hover:scale-105 transition-all duration-300 shadow-lg magnetic" id="cta-button" onclick="window.location.href='{{ route('ticket') }}'"   >
                    <span class="flex items-center gap-2">
            ...
            <div class="bg-white/95 backdrop-blur-md rounded-2xl mt-4 p-6 shadow-2xl gsap-scale">
                <div class="space-y-4">
                    ...
                    <div class="pt-4 border-t border-green-200">
                        <button class="w-full bg-yellow-400 hover:bg-yellow-300 text-green-900 font-bold py-3 px-6 rounded-full transition-all duration-300 magnetic" onclick="window.location.href=('ticket')" >
