...
<div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div class="space-y-3">
                <div class="flex justify-between">
                    ...
                    <span class="font-medium">{{ $ticket->user ? $ticket->user->name : $ticket->guest_name }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600">Email:</span>
                    <span class="font-medium">{{ $ticket->user ? $ticket->user->email : $ticket->guest_email }}</span>
                </div>
                <div class="flex justify-between">
    ...
    <!-- Back Button -->
    <div class="mt-6">
        <a href="{{ route('user.tickets.index') }}" class="inline-flex items-center text-green-600 hover:text-green-800">
...
document.addEventListener('DOMContentLoaded', function() {
    fetch('{{ route("user.tickets.qrcode", $ticket->id) }}')
